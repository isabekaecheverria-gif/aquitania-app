...
info = {
    "Sostenible (Agroecológica)": {
        ...
        "desc": "Basada en el programa 'Boyacá Siembra' y prácticas agroecológicas de AGROSAVIA (2022).",
    ...
    "Intermedia (Transición)": {
        ...
        "desc": "Manejo Integrado de Plagas para reducción de carga química.",
    ...
    "Convencional (Química)": {
        ...
        "desc": "Modelo intensivo con alta dependencia de pesticidas sintéticos (DANE, 2015).",
        "lago": "Impacto Crítico. Riesgo de eutrofización y degradación hídrica (Corpoboyacá, 2022).",
        "detalles": "Abastecimiento masivo a Corabastos (80% de la oferta nacional)."
    }
}
